...
final class Version20180825193143 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panels (id INT AUTO_INCREMENT NOT NULL, color_theme_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, subtitle VARCHAR(255) DEFAULT NULL, decorations JSON DEFAULT NULL COMMENT \'(DC2Type:json_array)\', nav_text VARCHAR(255) NOT NULL, nav_icon VARCHAR(255) NOT NULL, nav_order INT NOT NULL, displayed TINYINT(1) NOT NULL, INDEX IDX_8B137F498587EFC5 (color_theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
